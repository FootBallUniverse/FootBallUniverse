...
public class CGoalKeeper2Mesh : CDefaultMesh {
    ...
    // @Param	none		
    // @Return	none
    // @Date	2014/12/3  @Update 2014/12/4  @Author T.Kawashita      
    //----------------------------------------------------------------------
    void Start()
    {
        GameObject obj = this.transform.parent.transform.FindChild("GoalKeeper2NGUI").gameObject;
